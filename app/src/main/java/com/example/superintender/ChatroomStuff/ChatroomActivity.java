...
import com.example.superintender.R;
        ...
        View.OnClickListener
{
    ...
    public final int CAMERA_REQUEST=123;
    public final int GALLERY_REQUEST=124;
    ...
    ArrayList<UserAccounts> userlocations=new ArrayList<>();
    ...
    private void initChatroomRecyclerView(){
        mChatMessageRecyclerAdapter = new ChatMessageRecyclerAdapter(mMessages, new ArrayList<User>(), this,imageuri);
    ...
    {
        DocumentReference locations=mDb.collection("user_accounts")
                .document(user.getUser_id());
        locations.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful())
                    if(task.getResult().toObject(UserAccounts.class)!=null)
                    {
                        userlocations.add(task.getResult().toObject(UserAccounts.class));
                    }
            }
        });
    ...
    private void inflateUserListFragment(){
        ...
        transaction.addToBackStack("fragment_user_list");
        transaction.commit();
    }
    ...
    public void actiongalleryButton(View view)
    {
